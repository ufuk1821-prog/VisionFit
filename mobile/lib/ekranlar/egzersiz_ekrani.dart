...
const Map<String, List<Map<String, String>>> egzersizler = {
  'ust_gogus': [
    {'ad': 'Eğimli Barbell Bench Press', 'kisa': 'Üst göğüs için en yüksek kas aktivasyonunu sağlayan temel hareket.', 'detay': 'Bench açısı 30-45 derece arasında ayarlanır. Bar omuz genişliğinden biraz fazla tutuşla kavranır, göğsün üst kısmına kontrollü şekilde indirilir.', 'ipucu': 'Açıyı 45 dereceden fazla yapma, omuz devreye girer.'},
    {'ad': 'Eğimli Dumbbell Press', 'kisa': 'Hareket genişliği daha fazla, sakatlanma riski düşük.', 'detay': 'Dumbbellar göğüs hizasında tutulur, bench 30-45 derece eğimli. Yukarıda birbirine yakınlaşırlar ancak temas etmezler.', 'ipucu': 'Üst noktada dumbbelları birbirine vurma.'},
    {'ad': 'Eğimli Kablo Fly', 'kisa': 'İzolasyon hareketi, üst göğüs liflerini hedefler.', 'detay': 'Kablo makaraları en alt seviyeye ayarlanır. Eller aşağıdan yukarı kavis çizerek göğüs hizasında birleştirilir.', 'ipucu': 'Hareketin sonunda 1 saniye sıkma yap.'},
    {'ad': 'Smith Machine Press', 'kisa': 'Sabit bar yolu sayesinde form hatası riski az.', 'detay': 'Smith machinede bench 30-45 derece eğimli. Sabit yol dengeyi kaldırarak göğüse odaklanmayı sağlar.', 'ipucu': 'Bilek pozisyonunu nötr tut.'},
  ],
  'alt_gogus': [
    {'ad': 'Negatif Eğimli Bench Press', 'kisa': 'Alt göğüs liflerinde en yüksek aktivasyon.', 'detay': 'Bench 15-30 derece negatif eğimli, ayaklar üstüne kilitlenir.', 'ipucu': 'Ayakları sabitle, omurga pozisyonunu koru.'},
    {'ad': 'Dips (Göğüs Eğilimli)', 'kisa': 'Vücut ağırlığıyla alt göğüs için etkili.', 'detay': 'Paralel barlarda gövde öne eğik tutularak dirsekler bükülerek inilir.', 'ipucu': 'Gövdeyi ne kadar öne yatırırsan göğüs o kadar devreye girer.'},
    {'ad': 'Yukarıdan Aşağı Kablo Fly', 'kisa': 'Alt göğüs şekillendirme.', 'detay': 'Kablo makaraları en üst seviyeye ayarlanır. Eller karın hizasının önünde birleştirilir.', 'ipucu': 'Omuzları yukarı kaldırma.'},
  ],
  'sirt_kanat': [
    {'ad': 'Barfiks (Pull-Up)', 'kisa': 'Lat kaslarının gelişimi için en etkili temel hareket.', 'detay': 'Geniş tutuşla bar tutulur, göğüs bara doğru yükseltilir.', 'ipucu': 'Çekişi dirseklerle yönlendir.'},
    {'ad': 'Lat Pulldown', 'kisa': 'Barfiks alternatifi, ağırlık kontrolü kolay.', 'detay': 'Geniş tutuşla bar kavranır, gövde hafifçe geriye yaslanır.', 'ipucu': 'Vücudu fazla geriye yatırma.'},
    {'ad': 'Barbell Row', 'kisa': 'Sırt kalınlığı için temel bileşik hareket.', 'detay': 'Gövde kalçadan öne eğilerek bel düz tutulur.', 'ipucu': 'Belin yuvarlanmasına izin verme.'},
    {'ad': 'Tek Kol Dumbbell Row', 'kisa': 'Tek taraflı çalışma.', 'detay': 'Bir diz ve el bench üzerine yerleştirilir. Dumbbell kalça hizasına çekilir.', 'ipucu': 'Gövdeyi rotasyona sokma.'},
  ],
  'trapez': [
    {'ad': 'Barbell Shrug', 'kisa': 'Trapez için en yüksek yük.', 'detay': 'Bar bacakların önünde tutulur, omuzlar kulaklara doğru dikey kaldırılır.', 'ipucu': 'Üstte 1 saniye sık.'},
    {'ad': 'Dumbbell Shrug', 'kisa': 'Simetrik çalışma.', 'detay': 'Dumbbellar vücudun yanında tutulur, omuzlar yukarı kaldırılır.', 'ipucu': 'Sadece dikey hareket.'},
    {'ad': 'Face Pull', 'kisa': 'Duruş düzeltici hareket.', 'detay': 'Kablo yüz hizasından ip aparatıyla çekilir.', 'ipucu': 'Kürek kemiklerini sık.'},
  ],
  'alt_sirt': [
    {'ad': 'Deadlift', 'kisa': 'Tüm arka zinciri aktive eden temel hareket.', 'detay': 'Ayaklar kalça genişliğinde, sırt düz tutularak bar kaldırılır.', 'ipucu': 'Beli asla yuvarlama.'},
    {'ad': 'Romanian Deadlift', 'kisa': 'Hamstring ve alt sırt odaklı.', 'detay': 'Dizler hafif bükülü, bar bacak boyunca iner.', 'ipucu': 'Hareketi kalçadan başlat.'},
    {'ad': 'Good Morning', 'kisa': 'Hamstring ve alt sırt için esneklik.', 'detay': 'Bar omuzlarda, gövde öne eğilir.', 'ipucu': 'Beli düz tut.'},
  ],
  'on_omuz': [
    {'ad': 'Barbell Overhead Press', 'kisa': 'Ön omuz için temel bileşik hareket.', 'detay': 'Bar omuz genişliğinde tutulur ve yukarı itilir.', 'ipucu': 'Beli aşırı kavislendirme.'},
    {'ad': 'Dumbbell Shoulder Press', 'kisa': 'Simetrik omuz gelişimi.', 'detay': 'Dumbbellar kulak hizasında tutulur ve yukarı itilir.', 'ipucu': 'Üst noktada kas sıkması yap.'},
    {'ad': 'Ön Kaldırma', 'kisa': 'Ön omuz izolasyonu.', 'detay': 'Kollar düz, ağırlık öne ve yukarı omuz hizasına kadar kaldırılır.', 'ipucu': 'Momentum kullanma.'},
  ],
  'yan_omuz': [
    {'ad': 'Yan Kaldırma', 'kisa': 'Omuz genişliği için en etkili izolasyon.', 'detay': 'Kollar hafif bükülü, ağırlıklar yanlara kaldırılır.', 'ipucu': 'Küçük parmağı yukarı çevir.'},
    {'ad': 'Kablo Lateral Raise', 'kisa': 'Sabit direnç eğrisi.', 'detay': 'Tek kablo ile yapılır.', 'ipucu': 'Vücudu yana eğme.'},
  ],
  'arka_omuz': [
    {'ad': 'Bent-Over Lateral Raise', 'kisa': 'Arka omuz için temel izolasyon.', 'detay': 'Gövde öne eğik, ağırlıklar yanlara ve geriye kaldırılır.', 'ipucu': 'Momentum kullanma.'},
    {'ad': 'Face Pull', 'kisa': 'Arka omuz ve dış rotasyon.', 'detay': 'Kablo yüz hizasından çekilir, dirsekler dışa açılır.', 'ipucu': 'Dirsekleri omuz üzerinde tut.'},
  ],
  'biceps': [
    {'ad': 'Barbell Curl', 'kisa': 'Biceps için en yüksek yük.', 'detay': 'Bar tutulur, dirsekler sabit kalarak bar yukarı kıvrılır.', 'ipucu': 'Dirsekleri sabit tut.'},
    {'ad': 'Dumbbell Curl', 'kisa': 'Simetrik biceps gelişimi.', 'detay': 'Tekli dumbbell, kaldırırken bileği dışa döndür.', 'ipucu': 'Üst noktada 1 saniye sık.'},
    {'ad': 'Hammer Curl', 'kisa': 'Brachialis için de etkili.', 'detay': 'Avuç içi içe bakacak şekilde dumbbell kaldırılır.', 'ipucu': 'Yavaş ve kontrollü yap.'},
  ],
  'triceps': [
    {'ad': 'Close Grip Bench Press', 'kisa': 'Triceps için en yüksek yük.', 'detay': 'Dar tutuşla bench press yapılır.', 'ipucu': 'Tutuş çok dar olmasın.'},
    {'ad': 'Skull Crusher', 'kisa': 'Triceps uzun başı için etkili.', 'detay': 'Bar yatarak alın üzerine indirilir.', 'ipucu': 'Dirsekleri sabit tut.'},
    {'ad': 'Triceps Pushdown', 'kisa': 'Kablo ile izolasyon.', 'detay': 'Yüksek makaradan bar aşağı itilir.', 'ipucu': 'Alt noktada tam sık.'},
  ],
  'on_kol': [
    {'ad': 'Barbell Wrist Curl', 'kisa': 'Ön kol fleksör kasları.', 'detay': 'Oturarak bilekler dizlerin üzerinde, bar kıvrılır.', 'ipucu': 'Hareketi küçük ve kontrollü yap.'},
    {'ad': 'Reverse Curl', 'kisa': 'Brachioradialis ve ön kol.', 'detay': 'Barbell üstten tutuşla kıvrılır.', 'ipucu': 'Dirsekleri sabit tut.'},
  ],
  'core': [
    {'ad': 'Plank', 'kisa': 'Core stabilitesi için temel.', 'detay': 'Dirsekler ve ayak parmakları üzerinde vücut düz hatta tutulur.', 'ipucu': 'Kalçayı ne yukarı ne aşağı.'},
    {'ad': 'Crunch', 'kisa': 'Üst karın kasları.', 'detay': 'Sırtüstü yatarak omuzlar yerden kaldırılır.', 'ipucu': 'Boynu zorlaştırma.'},
    {'ad': 'Leg Raise', 'kisa': 'Alt karın kasları.', 'detay': 'Sırtüstü yatarak bacaklar yukarı kaldırılır.', 'ipucu': 'Beli yerden kaldırma.'},
    {'ad': 'Russian Twist', 'kisa': 'Oblik kaslar için.', 'detay': 'Oturarak ağırlıkla gövde iki yana döndürülür.', 'ipucu': 'Omurgayı dik tut.'},
  ],
  'quadriceps': [
    {'ad': 'Squat', 'kisa': 'Tüm alt vücut için temel.', 'detay': 'Ayaklar omuz genişliğinde, kalça diz seviyesine indirilir.', 'ipucu': 'Topuklar yerde kalmalı.'},
    {'ad': 'Leg Press', 'kisa': 'Quad odaklı makine hareketi.', 'detay': 'Makine platformuna ayaklar basılır ve bacaklar uzatılır.', 'ipucu': 'Dizleri tam kilitleme.'},
    {'ad': 'Lunge', 'kisa': 'Tek taraflı bacak çalışması.', 'detay': 'Öne adım atılır, ön diz 90 derece bükülür.', 'ipucu': 'Ön diz ayak ucunu geçmesin.'},
    {'ad': 'Leg Extension', 'kisa': 'Quad izolasyonu.', 'detay': 'Makine koltuğunda bacaklar uzatılarak kaldırılır.', 'ipucu': 'Tam genişleme yap.'},
  ],
  'hamstring': [
    {'ad': 'Romanian Deadlift', 'kisa': 'Hamstring için en etkili.', 'detay': 'Kalça geriye itilerek gövde öne eğilir.', 'ipucu': 'Hareketi kalçadan başlat.'},
    {'ad': 'Leg Curl', 'kisa': 'Hamstring izolasyonu.', 'detay': 'Yatarak veya oturarak bacaklar geriye bükülür.', 'ipucu': 'Kalçayı kaldırma.'},
  ],
  'kalca': [
    {'ad': 'Hip Thrust', 'kisa': 'Kalça için en yüksek aktivasyon.', 'detay': 'Omuzlar bench üzerinde, bar kalça üzerinde kaldırılır.', 'ipucu': 'Üst noktada 1-2 saniye sık.'},
    {'ad': 'Sumo Deadlift', 'kisa': 'Kalça ve iç bacak odaklı.', 'detay': 'Geniş duruş, ayak parmakları dışa.', 'ipucu': 'Kalçaları içe doğru it.'},
    {'ad': 'Glute Bridge', 'kisa': 'Ekipman gerektirmeyen kalça aktivasyonu.', 'detay': 'Sırtüstü dizler bükülü, kalça yukarı kaldırılır.', 'ipucu': 'Üst noktada sık.'},
  ],
  'baldir': [
    {'ad': 'Standing Calf Raise', 'kisa': 'Baldır kasları için temel.', 'detay': 'Ayak parmakları yükseltide durarak baldırlar kaldırılır.', 'ipucu': 'Topukları aşağı indir.'},
    {'ad': 'Seated Calf Raise', 'kisa': 'Soleus kasına odaklanır.', 'detay': 'Oturarak diz üzerinde ayak parmakları kaldırılır.', 'ipucu': 'Diz açısını 90 derecede tut.'},
  ],
};
...
class _EgzersizEkraniState extends State<EgzersizEkrani> with SingleTickerProviderStateMixin {
  ...
  void _diyagramGuncelle() {
    final slug = _kasToSlug[_seciliGrup] ?? '';
    _onWebController?.runJavaScript('setSelected("$slug")');
    _arkaWebController?.runJavaScript('setSelected("$slug")');
  }
...
<body>
<svg viewBox="0 0 100 200" xmlns="http://www.w3.org/2000/svg" id="model">
$svgIcerik
</svg>
<script>
var currentSlug = '';
...
setSelected('');
          ...
          children: [
            Container(
              ...
              child: TabBar(
                ...
                tabs: const [Tab(text: 'Vücut Diyagramı'), Tab(text: 'Kas Listesi')],
              ),
            ),
            Expanded(
              child: TabBarView(
                controller: _tabController,
                children: [_diyagramSekme(), _listeSekme()],
              ),
            ),
          ],
        ),
        if (_seciliEgzersiz != null) _detayModal(),
      ],
    );
  }

  Widget _diyagramSekme() {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Egzersiz Kütüphanesi', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
          ...
          Container(
            ...
            decoration: BoxDecoration(color: const Color(0xFFE8313F).withOpacity(0.15), borderRadius: BorderRadius.circular(10), border: Border.all(color: const Color(0xFFE8313F).withOpacity(0.4))),
            child: Row(children: [
              const Icon(Icons.touch_app_outlined, color: Color(0xFFE8313F), size: 18),
              const SizedBox(width: 8),
              Text('Seçili: ${kasGruplari[_seciliGrup] ?? _seciliGrup}', style: const TextStyle(color: Color(0xFFE8313F), fontWeight: FontWeight.w600, fontSize: 14)),
            ]),
          ),
          const SizedBox(height: 16),
          Text('${kasGruplari[_seciliGrup]} Hareketleri', style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w700)),
          const SizedBox(height: 12),
          ...(egzersizler[_seciliGrup] ?? []).asMap().entries.map((e) => _egzersizSatiri(e.key + 1, e.value)),
        ],
      ),
    );
  }

  Widget _diyagramPanel(String baslik, WebViewController? controller, bool on) {
    return Expanded(
      child: Column(
        children: [
          Text(baslik, style: const TextStyle(color: Color(0xFF888888), fontSize: 13, fontWeight: FontWeight.w500), textAlign: TextAlign.center),
          ...
          Container(
            ...
            child: controller != null
                ...
                : const Center(child: CircularProgressIndicator(color: Color(0xFFE8313F))),
          ),
        ],
      ),
    );
  ...
  Widget _listeSekme() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Kas Grupları', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
          const SizedBox(height: 16),
          GridView.builder(
            shrinkWrap: true,
            ...
            itemBuilder: (_, i) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  decoration: BoxDecoration(color: secili ? const Color(0xFFE8313F).withOpacity(0.15) : const Color(0xFF1A1A1A), borderRadius: BorderRadius.circular(10), border: Border.all(color: secili ? const Color(0xFFE8313F) : const Color(0xFF333333), width: secili ? 1.5 : 1)),
                  child: Center(child: Padding(padding: const EdgeInsets.all(4), child: Text(ad, style: TextStyle(color: secili ? const Color(0xFFE8313F) : const Color(0xFF888888), fontSize: 10, fontWeight: secili ? FontWeight.w700 : FontWeight.normal), textAlign: TextAlign.center, maxLines: 2, overflow: TextOverflow.ellipsis))),
                ),
              );
            },
          ),
  ...
  Widget _egzersizSatiri(int siralama, Map<String, String> egzersiz) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [
          Container(width: 32, height: 32, decoration: BoxDecoration(color: const Color(0xFFE8313F).withOpacity(0.15), borderRadius: BorderRadius.circular(8)), child: Center(child: Text('$siralama', style: const TextStyle(color: Color(0xFFE8313F), fontWeight: FontWeight.w700, fontSize: 13)))),
          const SizedBox(width: 12),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(egzersiz['ad']!, style: const TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w600)),
            const SizedBox(height: 2),
            Text(egzersiz['kisa']!, style: const TextStyle(color: Color(0xFF888888), fontSize: 12), maxLines: 2, overflow: TextOverflow.ellipsis),
          ])),
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    Expanded(child: Text(_seciliEgzersiz!['ad']!, style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w700))),
                    IconButton(icon: const Icon(Icons.close, color: Color(0xFF888888)), onPressed: () => setState(() { _seciliEgzersiz = null; })),
                  ]),
                  const SizedBox(height: 12),
                  Text(_seciliEgzersiz!['detay']!, style: const TextStyle(color: Color(0xFFCCCCCC), fontSize: 14, height: 1.6)),
                  const SizedBox(height: 16),
                  Container(
                    padding: const EdgeInsets.all(12),
                    decoration: BoxDecoration(color: const Color(0xFFE8313F).withOpacity(0.1), borderRadius: BorderRadius.circular(10), border: Border.all(color: const Color(0xFFE8313F).withOpacity(0.3))),
                    child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      const Icon(Icons.auto_awesome, color: Color(0xFFE8313F), size: 16),
                      const SizedBox(width: 8),
                      Expanded(child: Text(_seciliEgzersiz!['ipucu']!, style: const TextStyle(color: Color(0xFFE8313F), fontSize: 13, height: 1.5))),
                    ]),
                  ),
                ]),
              ),
